 ...
 */
public class MaxSessionTimeExpiredQuery<C extends Closeable> extends CTSWorkerBaseQuery<C> {
    ...
    public MaxSessionTimeExpiredQuery(
            @DataLayer(CTS_MAX_SESSION_TIMEOUT_WORKER) ConnectionFactory factory,
            @DataLayer(CTS_MAX_SESSION_TIMEOUT_WORKER) QueryFactory queryFactory,
