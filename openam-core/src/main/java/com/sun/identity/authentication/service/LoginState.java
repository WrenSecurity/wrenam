...
public class LoginState {
    ...
    private void populateUserAttributes(Map<String, Set<String>> userAttributes, boolean loginStatus,
        ...
        try {
            ...
            userAliasList = userAttributes.get(ISAuthConstants.USER_ALIAS_ATTR);
            ...
            if (aliasAttrNames != null && !aliasAttrNames.isEmpty()) {
                ...
                while (it.hasNext()) {
                    ...
                    Set attrVals = userAttributes.get(attrName);
                    if (attrVals != null) {
    ...
    private void setDecodedGoToOnFailURL() {
        String arg = requestHash.get("gotoOnFail");
