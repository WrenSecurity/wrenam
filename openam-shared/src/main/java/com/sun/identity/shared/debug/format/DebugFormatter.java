...
/**
 * Formatter that converts {@link DebugRecord} instances into string message
 * using a defined formatting strategy.
 */
public interface DebugFormatter {

    /**
     * Format the provided {@link DebugRecord} into a loggable string message.
     *
     * @param logRecord the debug record to format
     * @return a string message of the debug record
     */
