...
import org.wrensecurity.wrenam.authentication.modules.webauthn.impl.SecureRandomChallengeProviderImpl;
...
public class WebAuthnGuiceModule extends AbstractModule {
    ...
    protected void configure() {
        bind(WebAuthnChallengeProvider.class).to(SecureRandomChallengeProviderImpl.class);
    }
