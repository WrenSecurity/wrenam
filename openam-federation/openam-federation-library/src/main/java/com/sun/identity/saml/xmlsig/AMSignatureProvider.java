...
public class AMSignatureProvider implements SignatureProvider {
     ...
     * @throws XMLSignatureException if the document could not be signed
     */
    public org.w3c.dom.Element signXML(org.w3c.dom.Document doc, java.lang.String certAlias,
            java.lang.String algorithm) throws XMLSignatureException {
        if (doc == null) {
        ...
        try {
            ...
            if (c14nMethod == null || c14nMethod.length() == 0) {
                ...
                if (!isValidCanonicalizationMethod(c14nMethod)) {
                    throw new XMLSignatureException(
                            SAMLUtilsCommon.bundle.getString("invalidCanonicalizationMethod"));
                }
            ...
            if (transformAlg != null && transformAlg.length() != 0) {
                if (!isValidTransformAlgorithm(transformAlg)) {
                    throw new XMLSignatureException(SAMLUtilsCommon.bundle.getString(
    ...
    public Element signWithWSSSAMLTokenProfile(Document doc,
        ...
        try {
            ElementProxy.setDefaultPrefix(Constants.SignatureSpecNS, SAMLConstants.PREFIX_DS);
            Element wsucontext = com.sun.identity.saml2.common.XmlUtils.createNamespaceElement(doc, "wsu", wsuNS);
    ...
    public boolean verifyXMLSignature(org.w3c.dom.Document doc) throws XMLSignatureException {
        if (doc == null) {
            SAMLUtilsCommon.debug.error(
     ...
     * @throws XMLSignatureException if problem occurs during verification
     */
    public boolean verifyXMLSignature(org.w3c.dom.Element element) throws XMLSignatureException {
        if (element == null) {
    ...
    public boolean verifyXMLSignature(org.w3c.dom.Element element,
                                      java.lang.String certAlias) throws XMLSignatureException {
    ...
    public boolean verifyXMLSignature(org.w3c.dom.Document doc,
            java.security.cert.Certificate cert) throws XMLSignatureException {
        if (doc == null) {
            SAMLUtilsCommon.debug.error("verifyXMLSignature: " +
                    "document is null.");
            throw new XMLSignatureException(
     ...
     * @throws XMLSignatureException if problem occurs during verification
     */
    public boolean verifyXMLSignature(java.lang.String xmlString) throws XMLSignatureException {
     ...
     * @throws XMLSignatureException if problem occurs during verification
     */
    public boolean verifyXMLSignature(java.lang.String xmlString, java.lang.String certAlias)
            throws XMLSignatureException {
    ...
    public boolean verifyXMLSignature(java.lang.String xmlString, java.lang.String idAttrName,
        ...
        Document doc = XMLUtils.toDOMDocument(xmlString, SAMLUtilsCommon.debug);
        try {
            return verifyXMLSignature(doc, idAttrName, certAlias);
        } catch (Exception ex) {
            SAMLUtilsCommon.debug.error("verifyXMLSignature Exception: ", ex);
    ...
    private PublicKey getWSSTokenProfilePublicKey(Document doc) {
        ...
        try {
            ...
            if (reference != null) {
                ...
                id = id.substring(1);
                nscontext = com.sun.identity.saml2.common.XmlUtils.createNamespaceElement(
                        doc, SAMLConstants.PREFIX_WSU, wsuNS);
                Node n = XPathAPI.selectSingleNode(doc, "//*[@"+ SAMLConstants.PREFIX_WSU + ":" +
                ...
                if (n != null) { // X509 Security Token profile
                    ...
                    Element x509Data = (Element) reference.getElementsByTagNameNS(
                            Constants.SignatureSpecNS, SAMLConstants.TAG_X509DATA).item(0);
    ...
    protected PublicKey getPublicKeybyDSARSAkeyValue(Document doc, Element reference)
        ...
        if (dsaKey != null) { // It's DSAKey
            ...
            if (nodeCount > 0) {
                ...
                for (int i = 0; i < nodeCount; i++) {
                    ...
                    if (currentNode.getNodeType() == Node.ELEMENT_NODE) {
                        ...
                        BigInteger v = new BigInteger(Base64.decode(
            ...
            Element rsaKey = (Element) reference.getElementsByTagNameNS(
                    Constants.SignatureSpecNS,
