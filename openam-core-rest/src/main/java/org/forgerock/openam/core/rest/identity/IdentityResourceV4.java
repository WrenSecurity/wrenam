...
public class IdentityResourceV4 implements CollectionResourceProvider {
    ...
    public Promise<ResourceResponse, ResourceException> createInstance(Context context, CreateRequest request) {
        ...
        try {
            ...
            if (result != null) {
                ...
                return newResultPromise(identityMapper.toBasicResourceResponse(context, details, ssoToken));
            } else {
            ...
            debug.error("IdentityResourceV4.createInstance() :: Cannot READ resourceId={} : Resource cannot be found.",
                    resourceId, e);
            return new NotFoundException("Resource not found.", e).asPromise();
        } catch (TokenExpired e) {
            debug.error("IdentityResource.createInstance() :: Cannot CREATE resourceId={} : Unauthorized", resourceId, e);
    ...
    public Promise<QueryResponse, ResourceException> queryCollection(Context context, QueryRequest request,
        ...
        try {
            ...
            for (IdentityDetails identityDetails : result) {
                handler.handleResource(identityMapper.toBasicResourceResponse(context, identityDetails, ssoToken));
            }
        } catch (Exception e) {
    ...
    public Promise<ResourceResponse, ResourceException> readInstance(Context context, String resourceId,
        ...
        try {
            ...
            debug.error("IdentityResourceV4.readInstance :: Cannot READ resourceId={} : Resource cannot be found.",
            ...
            debug.error("IdentityResourceV4.readInstance :: Cannot READ resourceId={} : Unauthorized", resourceId,
                    tokenExpired);
            return new PermanentException(401, "Unauthorized", null).asPromise();
        } catch (AccessDenied accessDenied) {
            debug.error("IdentityResourceV4.readInstance :: Cannot READ resourceId={} : Access denied",
    ...
    public Promise<ResourceResponse, ResourceException> updateInstance(Context context, String resourceId,
        ...
        try {
            ...
            IdentityDetails newDetails = identityServices.read(details.getName(),
                    getIdentityServicesAttributes(realmName, objectType), ssoToken);
            return newResultPromise(identityMapper.toBasicResourceResponse(context, newDetails, ssoToken));
        } catch (ObjectNotFound e) {
            debug.error("IdentityResourceV4.updateInstance() :: Cannot UPDATE resourceId={} : Could not find the " +
            ...
            debug.error("IdentityResourceV4.updateInstance() :: Cannot UPDATE resourceId={} : Unauthorized",
                    resourceId, e);
            return new PermanentException(401, "Unauthorized", null).asPromise();
        } catch (AccessDenied e) {
            debug.error("IdentityResourceV4.updateInstance() :: Cannot UPDATE resourceId={} : Access denied",
                    resourceId, e);
