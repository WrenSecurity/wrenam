...
public class UmaPolicyServiceImplDelegationTest {
    ...
    private void accessingUriForUser(String username) {
        userInUri = username;
        given(contextHelper.getUserId(any())).willReturn(userInUri);
        given(contextHelper.getUserUid(any())).willReturn("uid=" + userInUri + ",ou="
    ...
    private void mockPolicyResourceDelegateForNewPolicy() {
        ...
        given(policyResourceDelegate.createPolicies(any(Context.class), anySet()))
    ...
    private void mockPolicyResourceDelegateForUpdatedPolicy() {
        ...
        given(policyResourceDelegate.updatePolicies(any(Context.class), any()))
    ...
    private void verifyPolicyIsNotCreatedForLoggedInUser() {
        verify(policyResourceDelegate, never()).createPolicies(any(Context.class), anySet());
    }
